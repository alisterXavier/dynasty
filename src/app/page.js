      ...
      <div className="overlay bg-[#1a1a1a6c] absolute top-0 w-screen h-[120vh] flex justify-center items-center">
        <div className="absolute top-[45%] right-[50%] translate-x-[50%] -translate-y-[50%]">
          <div className=" flex items-end hero-title-container">
            <h2 className="text-7xl revamp-font text-white hero-dynasty-title opacity-0">
              DYNASTY
            </h2>
            <div className="relative w-fit overflow-hidden">
              <h2 className="hero-dynasty-sub-title revamp-font-titi text-1xl text-white opacity-0">
                Real Estate
              </h2>
...
//         className="lg:text-[45px] md:text-[35px] text-[25px] text-black revamp-font-optima flex overflow-hidden"
//         transition={{
...
//       ref={ref}
//     >
//       <div className="lg:w-[50%] w-full h-[100%] flex items-center justify-center">
//         <motion.figure
//           className="relative w-full h-[250px] md:w-[600px] md:h-[400px]"
//           initial={{
//             translateX: '-100px',
//             opacity: 0,
//           }}
...
//         <div className="lg:w-[80%] md:w-[70%] flex flex-col justify-center items-center">
//           <div className="w-full">
//             <Title></Title>
//           </div>
//           <div className="flex flex-col justify-center w-full">
//             <p className="lg:text-[16px] text-[15px] w-[100%] text-black revamp-font-titi">
...
//           </div>
//           {/* <div className="my-5">
//           <p className="text-black revamp-font-titi">
//             {'Honesty Collaboration Esteem Devotion Equity'
//               .split(' ')
//               .map((i, index) => {
//                 return (
//                   <motion.span
//                     key={index}
//                     className="
//                       block py-2 w-[200px] cursor-default hover:ml-2 transition-all
//                       after:block after:content-[''] after:w-[0px] after:bg-black after:bottom-0 after:left-0 after:h-[1px] hover:after:w-[200px] after:transition-all
//                       after:duration-200"
//                   >
//                     {i}
//                   </motion.span>
...
//             <button className="px-8 py-2 bg-blue-500 text-white revamp-font-titi transition duration-200 hover:bg-white hover:text-black border-[1px] border-transparent hover:border-blue-500">
//               Meet The Team
//             </button>
//           </div>
//         </div>
...
//       <figure className="absolute -top-[150%] left-0 right-0 -bottom-[150%] flex items-center justify-center">
...
//         <h1 className="text-[30px] revamp-font-optima text-white">
//           Award Winning Real Estate Agency
//         </h1>
//         <p className="revamp-font-titi text-white">
...
//       <div className="my-5">
//         <h1 className="revamp-font-optima text-[30px]">Testimonials</h1>
//       </div>
...
//             <p className="revamp-font-titi dynasty-contact-para text-[10px]  md:text-[15px] lg:text-[15px]">
//               Whether you&apos;re a first-time buyer seeking a seamless
//               experience, looking for a family-friendly home in a vibrant
//               community, or aiming to unlock smart investments with cutting-edge
//               properties that maximize your returns, our team of experts is here
//               to guide you every step of the way.
//             </p>
//             <p className="revamp-font-titi  dynasty-contact-email text-[10px] md:text-[15px] lg:text-[15px]">
//               Our Email -
//               <span className="text-blue-500 text-[10px] md:text-[15px] lg:text-[15px]">
//                 hello@dynastyrealestate.ae
//               </span>
//             </p>

//             <p className="revamp-font-titi dynasty-contact-number block text-[10px] md:text-[15px] lg:text-[15px] pr-5">
//               Direct Line -
//               <span className="text-blue-500 text-[10px] md:text-[15px] lg:text-[15px]">
...
//           </div>
//           <div className="my-5">
//             <button className="px-8 py-2 bg-blue-500 text-white revamp-font-titi transition duration-200 hover:bg-white hover:text-black border-[1px] border-transparent hover:border-blue-500 text-[10px] md:text-[20px] lg:text-[20px]">
//               Connect with Us
//             </button>
//           </div>
//         </div>
//       </div>
//       <div
//         className="lg:w-[40%] h-full md:w-[40%] w-full absolute md:relative lg:relative overflow-hidden flex flex-col items-center justify-center"
...
//         <h1 className="revamp-font-optima text-[30px]">OUR PARTNERS</h1>
//         <p className="revamp-font-titi text-[16px]">
...
//         <div className="flex flex-wrap lg:w-[80%] w-full h-[100%]">
//           <div className="md:w-[50%] w-full h-[100%]">
//             <h1 className="md:text-[20px] text-[15px] revamp-font text-white">
//               Head Office
//             </h1>
...
//           </div>
//         </div>
//         <div className="flex flex-col md:my-0 my-5  lg:w-[20%] h-[100%]">
//           <div>
//             <h1 className="text-white revamp-font-optima">Explore</h1>
//           </div>
